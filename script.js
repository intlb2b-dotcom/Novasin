const translations = {
  ...
  en: {
    ...
    heroDesc: 'Help international food brands enter China right. Provide fully compliant end-to-end supply, faster market access, and ready-to-go channel launches that get your products from port to shelf in record time.',
