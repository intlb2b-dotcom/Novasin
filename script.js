const translations = {
  zh: {
    ...
    product1Title: '饮料与酒类',
    product1Desc: '咖啡，饮品与进口精酿，渠道覆盖广泛。',
    product2Title: '休闲零食',
    product2Desc: '来自全球的零食与干货，满足年轻消费群体。',
    product3Title: '糖果与甜点',
    product3Desc: '精选进口糖果与烘焙原料，适配电商与线下渠道。',
    product4Title: '特色食品',
  ...
  en: {
    ...
    product1Title: 'Beverages & Spirits',
    product1Desc: 'Coffee, drinks and imports with broad channel coverage.',
    product2Title: 'Snacks',
    product2Desc: 'Trending global flavors captured to captivate younger generations.',
    product3Title: 'Confectionery & Sweets',
    product3Desc: 'Curated global delights tailored for online and offline.',
