const translations = {
  ...
  en: {
    ...
    heroDesc: 'Help international food brands enter and scale in China. Provide fully compliant end-to-end supply, flexible cooperation, faster market access, and ready-to-go channel launches that get your products from port to shelf in record time.',
    ...
    contactDesc: 'Brands owner and channel partners are welcome to contact for cooperation opportunities and collaboration models.',
